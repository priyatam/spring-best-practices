INSERT into addresses(addr_line1,addr_line2,city,state,zip,type) VALUES('100 memorial dr','','cambridge','MA','02139','HOMEOWNER');
INSERT into addresses(addr_line1,addr_line2,city,state,zip,type) VALUES('100 cambridge st','Apt 1','cambridge','MA','02141','HOMEOWNER');
INSERT into addresses(addr_line1,addr_line2,city,state,zip,type) VALUES('100 Mass Ave','Ste 1','Boston','MA','02116','RENTAL');
...
INSERT INTO driving_histories(driver_id, annual_mileage,is_primary_operator,is_accident) VALUES(1,15000,TRUE,FALSE);
INSERT INTO driving_histories(driver_id, annual_mileage,is_primary_operator,is_accident,is_third_party_offence) VALUES(1,25000,FALSE,TRUE,TRUE);
